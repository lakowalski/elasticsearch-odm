...
Model.prototype.toObject = function() {
  function cloneSchemaProperties(schema, object) {

    if (Object.hasOwnProperty.call(schema, 'type')) { // we've hit a leaf
      return object;
    } else {
      ...
      Object.keys(schema).forEach((key) => {
        if(Object.hasOwnProperty.call(object, key)) {
          returnBranch[key] = cloneSchemaProperties(schema[key], object[key]);
        }
      })
      return returnBranch;
    }
  ...
  if (this.constructor.model.schema) {
    // console.log(cloneSchemaProperties(this.constructor.model.schema.fields, this))
    return cloneSchemaProperties(this.constructor.model.schema.fields, this)
  }
